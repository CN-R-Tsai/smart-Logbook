...
| Maintenance KPIs | Visual Insights  | Quick Search | Status Tracking  | AI/DX Blog  |
|---|---|---|---|---|
| An overview UI for checking maintenance log. A Key Performance Indicator(KPIs) info boxes are avilable for users to track the logs status. User can do CRUD operations. | Several data visualization help users to draw insights |  Able to quick search maintenance history | Design for tracking equipment status | An internal blog platform to share the ideas |
